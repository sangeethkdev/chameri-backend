...
// uploads them directly (see /api/uploads/signature) and sends the resolved
// features array (with final image URLs) here as plain JSON, so no upload
...
// Media already lives on Cloudinary by the time this runs — the frontend
// uploads it directly (see /api/uploads/signature) and sends the resulting
// video/image URLs here as plain JSON, so no upload middleware is needed.
router.put(
